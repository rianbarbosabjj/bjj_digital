...
# =========================================
# 🚀 ROTEADOR PRINCIPAL (MUDANÇA CRÍTICA)
# =========================================
...
def tela_login():
    ...
    with c2:
        ...
        authorize_button = oauth_google.authorize_button(
...
if __name__ == "__main__":
    ...
    # 2. Tenta pegar o token do Google (após o redirect)
    # Esta função só retorna algo se o usuário foi redirecionado pelo Google
    token = oauth_google.get_access_token()
    if token and st.session_state.token is None:
        ...
        st.rerun() # Re-executa o script para a lógica abaixo funcionar
