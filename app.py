...
# --- IMPORTAÇÕES LOCAIS (SEM ESPAÇOS NO INÍCIO) ---
                ...
                if not email_rec:
                    ...
                    if len(query) > 0:
                        ...
                        if usuario_encontrado.get("auth_provider") == "google":
                            st.error("Este e-mail usa login social (Google). Clique em 'Continuar com Google'.")
                        else:
                            with st.spinner("Gerando senha e enviando e-mail..."):
                                # 3. Gerar senha temporária e Hash
                                ...
                                try:
                                    ...
                                    if enviou:
                                        st.success("✅ Sucesso! Verifique seu e-mail (e a caixa de spam).")
                                    else:
                                        st.error("Erro ao conectar com servidor de e-mail.")
