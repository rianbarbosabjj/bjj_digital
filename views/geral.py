...
def tela_inicio():
    ...
    if tipo in ["admin", "professor"]:
        ...
        with c1: render_card("🧠 Gerir Questões", "Visualize o banco de questões, crie e solicite alterações de questões.", "Acessar", "g1", "Gestão de Questões")
        with c2: render_card("🏛️ Gerir Equipe", "Gerencie sua equipe", "Gerenciar", "g2", "Acessar")
        with c3: render_card("📜 Gerir Exames", "Crie, edite e autorize exames de faixa. "Gerenciar", "g3", "Acessar")
